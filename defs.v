...
`define CC_SET_BIT_WIDTH  7
`define CC_TAG_BIT_WIDTH  21
`define CC_SET_BIT_WIDTH_D  7
`define CC_TAG_BIT_WIDTH_D  21
`define CC_OFFSET_SIZE  4
`define CC_LINE_SIZE  4
`define CC_WAY_SIZE  4
`define CC_SET_SIZE  128
`define CC_SET_SIZE_D  128
// `define CC_TAG_SIZE  262144

`define CC_LINE_WIDTH 151
`define CC_LINE_TAG 150:130
`define CC_LINE_WIDTH_D 151
`define CC_LINE_TAG_D 150:130
...
`define CC_ADDR_TAG 31:11
`define CC_ADDR_SET 10:4
`define CC_ADDR_TAG_D 31:11
`define CC_ADDR_SET_D 10:4
`define CC_ADDR_OFFSET 3:2

`define CC_AXI_OP_RD  1'b0
`define CC_AXI_OP_WR  1'b1
// `define CC_AXI_OP_INVALID  2'b11

`define CC_STATE_AVAILABLE 4'b0000
`define CC_STATE_AXISTALL_READ 4'b0001
`define CC_STATE_AXISTALL_WRITE 4'b0010
`define CC_STATE_AXIREADING 4'b0011
`define CC_STATE_AXILOADING 4'b0100
`define CC_STATE_AXIWRITING 4'b0101
`define CC_STATE_AXILOADING_LAST 4'b0110
`define CC_STATE_FLUSH 4'b0111
`define CC_STATE_UNCACHE 4'b1000
`define CC_STATE_UNCACHE_AXISTALL_READ 4'b1001
`define CC_STATE_UNCACHE_AXISTALL_WRITE 4'b1010
`define CC_STATE_UNCACHE_AXIREADING 4'b1011
`define CC_STATE_UNCACHE_AXILOADING 4'b1100
`define CC_STATE_UNCACHE_AXIWRITING 4'b1101
